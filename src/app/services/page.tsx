                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {services.map((service, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{service.categoryName}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{service.subcategoryName}</td>
