...
import { TagIcon, DocumentTextIcon, CheckCircleIcon, CubeIcon } from '@heroicons/react/24/outline';
...
const mockServices: FormData[] = [
  {
    name: 'Phone Repair',
    categoryId: '1',
    subcategoryId: '1',
    description: 'Repair services for smartphones',
    status: 'Active',
  },
  {
    name: 'Laptop Upgrade',
    categoryId: '1',
    subcategoryId: '2',
    description: 'Upgrade RAM and SSD for laptops',
    status: 'Active',
  },
  {
    ...
    categoryId: '2',
    subcategoryId: '3',
    description: 'Custom prints on T-shirts',
    status: 'Inactive',
  },
];
...
export default function EditServicePage() {
  ...
  // Mock fetching service by ID
  const serviceIndex = parseInt(serviceId) % mockServices.length;
  const initialService = mockServices[serviceIndex] || mockServices[0];

  const [formData, setFormData] = useState<FormData>(initialService);
